...
def obtain_results(file_name, model):
    score, total = 0, 0
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='../models/task_routing_model', help='Path to model')
    args = parser.parse_args()

    model = AutoModelForCausalLM.from_pretrained(args.model_path)

    print("Beginning evaluation...")
    final_score, total = obtain_results(args.qa_file, model)
