...
def main():
    ...
    parser.add_argument('--input_file', type=str, default='./WVQ_China_Train.jsonl', help='Path to the input JSONL file')
    parser.add_argument('--output_file', type=str, default="./WVQ_China_Train_Llama.jsonl", help='Path to the output JSONL file')
